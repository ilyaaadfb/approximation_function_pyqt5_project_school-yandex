...
# Form implementation generated from reading ui file 'main_interface1.1.ui'
#
...
"border:0.5px solid black;")
    ...
    def retranslateUi(self, Function_approximation):
        ...
        self.action_exit.setText(_translate("Function_approximation", "Выход"))
        self.action_rus.setText(_translate("Function_approximation", "Английский"))
        self.action_en.setText(_translate("Function_approximation", "Русский"))
        self.action_reference.setText(_translate("Function_approximation", "О прогрмме"))
